...
async function shopeeOrderNotif() {
  ...
  try {
    ...
    try {
      ...
      const selectOrdersQuery = `SELECT * FROM Orders_Shopee WHERE DISCORD_CHANNEL IS NULL ORDER BY CREATED_DATE ASC LIMIT 1`;
...
async function lazadaOrderNotif() {
  ...
  try {
    ...
    try {
      ...
      const selectOrdersQuery = `SELECT * FROM Orders_Lazada WHERE DISCORD_CHANNEL IS NULL ORDER BY CREATED_DATE ASC LIMIT 1`;
...
async function tiktokOrderNotif() {
  ...
  try {
    ...
    try {
      ...
      const selectOrdersQuery = `SELECT * FROM Orders_Tiktok WHERE DISCORD_CHANNEL IS NULL ORDER BY CREATED_DATE ASC LIMIT 1`;
